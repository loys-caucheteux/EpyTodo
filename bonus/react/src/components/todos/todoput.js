...
class TodoForm extends React.Component {
    ...
    getData() {
        Axios.put(String('http://localhost:8080/todo'),
        ...
        <div className="container">
          <form onSubmit={this.handleSubmit}>
            <div className="d-grid gap">
              ...
              <input className="form-control" type="text" value={this.state.description} placeholder="Description" onChange={this.handleChangeDesc} />
              <label for="due_time">Due Time</label>
              <input className="form-control" name="due_time" id="due_time" type="text" value={this.state.due_time} placeholder="yyyy-mm-dd HH:MM:SS" onChange={this.handleChangeDueTime} />
              <input className="form-control" type="text" value={this.state.user_id} placeholder="User ID" onChange={this.handleChangeUid} />
              <label for="status">Status</label>
              <select name="status" id="status" onChange={this.handleChangeStatus}>
